                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setPracticeSettings(prev => ({ ...prev, showProgress: checked }))
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setPracticeSettings(prev => ({ ...prev, allowBookmarks: checked }))
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setPracticeSettings(prev => ({ ...prev, showExplanations: checked }))
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setPracticeSettings(prev => ({ ...prev, allowReview: checked }))
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => 
                        setPracticeSettings(prev => ({ ...prev, saveProgress: checked }))
                      }
                    />
