...
export default function QuestionBankManagement() {
  ...
  const handleOpenDrawer = (question: Partial<Question> | null = null) => {
    if (question) {
      setIsEditing(true);
          ...
          <div className="flex-grow p-6 space-y-6 overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Select value={currentQuestion.type} onValueChange={(v: 'MCQ' | 'Hotspot' | 'DragDrop') => setCurrentQuestion(p => ({...p, type: v}))}>
                ...
                <div>
                  ...
                  <Select value={currentQuestion.domain} onValueChange={(v: 'People' | 'Process' | 'Business Environment') => setCurrentQuestion(p => ({...p, domain: v}))}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div>
                    ...
                    <Select value={currentQuestion.difficulty} onValueChange={(v: 'Easy' | 'Medium' | 'Hard') => setCurrentQuestion(p => ({...p, difficulty: v}))}>
                 ...
                 <div>
                    ...
                    <Select value={currentQuestion.status} onValueChange={(v: 'Active' | 'Draft') => setCurrentQuestion(p => ({...p, status: v}))}>
