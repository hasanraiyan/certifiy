...
import { AdminProvider } from '@/context/admin-context'; // Add this import
import { AuthGuard } from '@/components/auth/auth-guard'; // Add this import
...
export default function AdminLayout({
  ...
  return (
    <AuthGuard allowedRoles={['admin']}>
      <AdminProvider> {/* Wrap children with AdminProvider */}
