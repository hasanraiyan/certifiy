 ...
 */
export function validateExamSession(session, questions) {
  const errors = []
  const warnings = []
 ...
 * Validate basic session structure
 */
function validateSessionStructure(session, errors, warnings, recoveryActions) {
 ...
 * Validate exam configuration
 */
function validateExamConfig(config, errors, warnings, recoveryActions) {
  if (!config) return
 ...
 * Validate session state
 */
function validateSessionState(session, errors, warnings, recoveryActions) {
  // Validate status
 ...
 */
function validateAnswers(session, questions, errors, warnings, recoveryActions) {
 ...
 * Validate timestamps
 */
function validateTimestamps(session, errors, warnings, recoveryActions) {
  const now = new Date()
 ...
 * Validate data consistency
 */
function validateDataConsistency(session, errors, warnings, recoveryActions) {
 ...
 */
export function applyRecoveryActions(session, actions) {
...
function getDefaultTimeLimit(examType) {
  switch (examType) {
...
function resetNestedProperty(obj, path) {
  const keys = path.split('.')
  let current = obj
 ...
 */
export function hasValidSessionStructure(session) {
  return !!(
    session &&
