 ...
 */
export function saveSessionForRecovery(session, questions, options = {}) {
  try {
 ...
 */
export function recoverSession(sessionId, options = {}) {
  try {
    ...
    const session = deserializeExamSession(recoveryData.session)
 ...
 */
export function listRecoverableSessions() {
  try {
 ...
 */
export function deleteRecoveryData(sessionId) {
  try {
    const storageKey = RECOVERY_STORAGE_KEY + sessionId
 ...
 */
export function cleanupOldRecoveryData(maxAgeHours = DEFAULT_MAX_RECOVERY_AGE) {
  try {
 ...
 */
export function hasRecoveryData(sessionId) {
  try {
    const storageKey = RECOVERY_STORAGE_KEY + sessionId
 ...
 */
export function validateRecoveryData(sessionId) {
  try {
 ...
 */
export function exportRecoveryData(sessionId) {
  try {
    const storageKey = RECOVERY_STORAGE_KEY + sessionId
    const recoveryDataStr = localStorage.getItem(storageKey)
 ...
 */
export function importRecoveryData(data) {
  try {
...
function updateRecoveryIndex(sessionId, recoveryId) {
  try {
    const index = getRecoveryIndex()
 ...
 */
export function getRecoveryInfo(sessionId) {
  try {
