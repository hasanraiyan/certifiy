 ...
 */
export function deserializeExamSession(serialized) {
  return {
    id: serialized.id,
 ...
 */
export function serializeExamResults(results) {
  return {
 ...
 */
export function deserializeExamResults(serialized) {
  return {
 ...
 */
export function determinePassStatus(score, passingThreshold = 70) {
 ...
 */
export function calculateDomainScores(questionResults) {
 ...
 */
export function validateAnswerForQuestion(answer, question) {
 ...
 */
export function calculatePartialCredit(selectedOptions, correctOptions) {
 ...
 */
export function validateAndScoreAnswer(answer, question) {
  const errors = [];
 ...
 */
export function createDefaultExamSettings() {
  return {
    showTimer: true,
    showProgress: true,
    allowReview: true,
 ...
 */
export function mergeExamSettings(settings) {
