...
export interface UseNetworkStatusReturn {
  ...
  connectionHistory: Array<{ timestamp: Date; isOnline: boolean }>
}
...
export function useNetworkStatus(): UseNetworkStatusReturn {
  ...
  const [connectionHistory, setConnectionHistory] = useState<Array<{ timestamp: Date; isOnline: boolean }>>([])
  ...
  const addConnectionEvent = useCallback((isOnline: boolean) => {
